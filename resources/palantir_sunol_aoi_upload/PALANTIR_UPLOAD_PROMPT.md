...
- AOI: `aoi/sunol_training_area_aoi.geojson`
- OSM power infrastructure: `osm/osm_power_lines.geojson`, `osm/osm_power_towers_poles.geojson`
- Official power infrastructure: `official_power/cec_transmission_lines.geojson`, `official_power/hifld_transmission_lines.geojson`
- Roads, tracks, and paths: `osm/osm_roads_tracks_paths.geojson`
- Buildings: `osm/osm_buildings.geojson`
- Natural features: `osm/osm_natural_features.geojson`
- Waterways and barriers: `osm/osm_waterways_barriers.geojson`
- Terrain samples and attention points: `terrain/elevation_samples_500m.csv`, `terrain/terrain_attention_points.geojson`
- Mission route: `mission_fixture/synthetic_unit_route.geojson`
- Drone waypoint queue: `mission_fixture/synthetic_drone_waypoints.geojson`
- Route branches: `mission_fixture/synthetic_route_branches.geojson`
- Cue zones: `mission_fixture/synthetic_cue_zones.geojson`
- No-go/review zones: `mission_fixture/synthetic_no_go_zones.geojson`
