...
- Inputs: SelectedMissionObject from Cesium selection events.
- Outputs: Human-readable object id, layer, name, and properties.
...
Current Limits / TODO:
- Editing and state-machine actions are deferred to later goals.
...
export function SelectedObjectPanel({ selectedObject }: SelectedObjectPanelProps) {
  ...
  return (
    <section className="panel-section object-panel">
      <div className="panel-heading">
        ...
        <span>{selectedObject ? selectedObject.layerLabel : "none"}</span>
      </div>
      {selectedObject ? (
        <>
